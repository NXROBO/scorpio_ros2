...
def generate_launch_description():
    ...
    declare_config_filepath = DeclareLaunchArgument(
        'config_filepath', 
        default_value=[launch.substitutions.TextSubstitution(text=os.path.join(get_package_share_directory('scorpio_teleop'), 'config', '')),joy_config, launch.substitutions.TextSubstitution(text='.config.yaml')],
    ...
    rviz_config_dir = os.path.join(get_package_share_directory('scorpio_yolov8'), 'rviz', 'scorpio_yolov8.rviz')
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
