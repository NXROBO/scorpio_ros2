...
def generate_launch_description():
    ...
    scorpio_cartographer_dir = get_package_share_directory('scorpio_cartographer')
    ...
    slam_group = GroupAction([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(scorpio_cartographer_dir, 'launch',
    ...
    scorpio_delay_save_map_action = TimerAction(period=5.0, actions=[scorpio_save_map_node])
