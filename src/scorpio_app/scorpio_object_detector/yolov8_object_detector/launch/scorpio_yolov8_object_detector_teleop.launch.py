...
def generate_launch_description():
    ...
    scorpio_teleop_dir = get_package_share_directory('scorpio_teleop')
    ...
    scorpio_yolov8_object_detector_node = launch_ros.actions.Node(
    ...
    scorpio_object_detector_rviz_node = launch_ros.actions.Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
    ...
    ld.add_action(scorpio_yolov8_object_detector_node)
    ld.add_action(scorpio_object_detector_rviz_node)
