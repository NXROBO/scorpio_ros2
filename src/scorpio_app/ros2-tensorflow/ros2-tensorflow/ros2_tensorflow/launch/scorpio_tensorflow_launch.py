...
# os.system("export PYTHONPATH=$PYTHONPATH:/home/scorpio/models/research && cd /home/scorpio/models/research && protoc object_detection/protos/*.proto --python_out=.")
def generate_launch_description():
    ...
    scorpio_tf_node = launch_ros.actions.Node(
    ...
    scorpio_tf_rviz_node = launch_ros.actions.Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
    ...
    ld.add_action(scorpio_tf_node)
    ld.add_action(scorpio_tf_rviz_node)
