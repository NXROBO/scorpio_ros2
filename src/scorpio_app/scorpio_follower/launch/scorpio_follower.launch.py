...
def generate_launch_description():
    ...
    scorpio_teleop_dir = get_package_share_directory('scorpio_follower')
    ...
    scorpio_follower_node = launch_ros.actions.Node(
        package='scorpio_follower',
        executable='scorpio_follower_node',  
        output='screen',
        emulate_tty=True,
        )
    ...
    ld.add_action(scorpio_follower_node)
    return ld
