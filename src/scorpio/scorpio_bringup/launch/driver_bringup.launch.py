...
def generate_launch_description():
    ...
    scorpio_base_dir = get_package_share_directory('scorpio_base')
...
#        choices=['ydlidar_g2', 'ydlidar_g6'],
    ...
    rviz_config_dir = os.path.join(get_package_share_directory('scorpio_bringup'), 'rviz', 'urdf.rviz')
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
    ...
    bringup_cmd_group = GroupAction([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(scorpio_description_dir, 'launch',
                                                       'scorpio_description.launch.py')),
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(scorpio_base_dir, 'launch',
                                                       'scorpio_base.launch.py')),
